                    ...
                    <Wrapper className="font-sans text-xl">
                        <div className="max-w-200">
                            ...
                            <p>
                                ...
                                Ihre von uns verarbeiteten personenbezogenen
                                Daten:
                            </p>
                            <ul>
                                <li>
                                    Auskunft (Art. 15 DSGVO): Sie können
                                    Auskunft über die von uns verarbeiteten
                                    Daten verlangen.
                                </li>
                                <li>
                                ...
                                <li>
                                    ...
                                    DSGVO): Sie können die Einschränkung der
                                ...
                                <li>
                                    Datenübertragbarkeit (Art. 20 DSGVO): Sie
                                    haben das Recht, Daten, die wir
                                    automatisiert verarbeiten, an sich oder an
                                    einen Dritten in einem gängigen,
                                    maschinenlesbaren Format aushändigen zu
                                    lassen.
                                </li>
                                <li>
                                    Beschwerderecht (Art. 77 DSGVO): Sie haben
                                    das Recht, sich bei einer Aufsichtsbehörde
                                    zu beschweren, wenn Sie der Ansicht sind,
                                    dass die Verarbeitung Ihrer
                                    personenbezogenen Daten nicht rechtmäßig
                                    erfolgt. Die für uns zuständige
                                    Aufsichtsbehörde ist der
                                    Landesdatenschutzbeauftragte des
                                    Bundeslandes, in dem unser Unternehmen
                                    seinen Sitz hat.
                                </li>
                            </ul>
                            <h3>
                            ...
                            <p>
                                Wir nutzen externe Dienstleister für das Hosting
                                und die Auslieferung unserer Website. Beim
                                Aufruf unserer Website werden systembedingt
                                Daten (sogenannte Server-Log-Dateien) an die
                                Server übermittelt und dort temporär
                                gespeichert. Hierzu zählen:
                            </p>
                            <ul>
                            ...
                            <ul>
                                <li>
                                    Contabo GmbH (Hosting): Welfenstraße 22,
                            ...
                            <p>
                                ...
                                Endeinrichtung der Nutzer speichern oder
                                auslesen (§ 25 TDDDG).
                            </p>
                        </div>
                    </Wrapper>
